...
void ovs_create_port(struct ovsdb_idl_txn *ovs_idl_txn,
...
void ovs_remove_port(const struct ovsrec_bridge *bridge,
                     const struct ovsrec_port *port);
void ovs_update_iface(const struct ovsrec_interface *iface,
                      const char *type,
